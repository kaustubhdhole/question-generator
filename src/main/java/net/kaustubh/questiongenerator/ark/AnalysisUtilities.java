...
package net.kaustubh.questiongenerator.ark;

import net.didion.jwnl.data.IndexWord;
import net.didion.jwnl.data.POS;
import net.didion.jwnl.dictionary.Dictionary;
import net.kaustubh.questiongenerator.transducer.ConstituencyParser;
...
public class AnalysisUtilities {
    ...
    private AnalysisUtilities() {
        ...
        parser = null;
        String propertiesPath =AnalysisUtilities.class.getClassLoader().getResource("config" +File.separator+"verbConjugations.txt").getPath();
        conjugator = new VerbConjugator();
        conjugator.load(GlobalProperties.getProperties().getProperty("verbConjugationsFile", propertiesPath));
   ...
   /* public static List<String> getSentences(String document) {
        ...
        for (int i = 0; i < paragraphs.length; i++) {
            ...
            try {
                sents = dp.getSentencesFromText(reader,null);
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public ParseResult parseSentence(String sentence) {
        Tree parse = constituencyParser.parse(sentence);
        return new ParseResult(true, parse, 100d);
    }
