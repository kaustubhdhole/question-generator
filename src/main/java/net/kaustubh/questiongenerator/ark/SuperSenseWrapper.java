...
public class SuperSenseWrapper {
	private SuperSenseWrapper(){
		sst = null;
		String propertiesPath = SuperSenseWrapper.class.getClassLoader().getResource("config/QuestionTransducer.properties").getPath();
		DiscriminativeTagger.loadProperties(GlobalProperties.getProperties().getProperty("propertiesFilePath", propertiesPath));
	}
